    ...
    pub fn scan_tokens(source: &str) -> Result<Vec<Token>, Vec<LoxError>> {
        ...
        while let Some((index, c)) = chars.next() {
            match c {
                ...
                '.' => {
                    add_token(&mut tokens, source, TokenType::Dot, &mut start_index, index);
                    break;
                }
                '-' => {
                    add_token(
                ...
                '/' => {
                    if let Some((_, '/')) = chars.peek(){
                        ...
                        add_token(&mut tokens, source, TokenType::Slash, &mut start_index, index, current_line);
                    }
                    break;
                }
                '"' => {
                ...
                _ => {
                    errors.push(LoxError::UnexpectedCharacter(current_line, c));
                    break;
                }
            }
        }
